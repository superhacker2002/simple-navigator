...
class GraphAlgorithms {
 public:
  ...
  ~GraphAlgorithms() = delete;
  static VerticesList depthFirstSearch(const Graph &graph, int start_vertex);
  static VerticesList breadthFirstSearch(const Graph &graph, int start_vertex);
 ...
 private:
  ...
  static VerticesList getHeirsIndexes_(const Graph &graph, int start_vertex);
